...
public class FetchRequestHandler implements IGraphQLRequest{
    ...
    public FetchRequestHandler(String apiEndpoint, Map<String, String> header, Map<String, String> param, Secret secret, String body) {
